...
let defaultLines = {
    custom: [ 
        ...
        [ 
            new EuclideanLine(8, 3, 0, ''),
            new EuclideanLine(8, 1, 4, ''),
            new EuclideanLine(5, 2, 2, ''),
            new EuclideanLine(10, 3, 5, '')
        ],


    ],
    asia: [
        [ // List of Traditional Rhythms
        ...
        [ // initial default list for the environment
            new EuclideanLine(8, 3, 5, ''),
            new EuclideanLine(8, 1, 4, ''),
    ...
    europe: [
        ...
        [ // Lista iniziale dei parametri euclidiani MODE 1
            new EuclideanLine(7, 3, 0, ''),
            new EuclideanLine(8, 2, 2, ''),
            new EuclideanLine(9, 3, 0, ''),
            new EuclideanLine(16, 4, 2, '')
        ],
    ...
    africa: [
        ...
        [ // Lista iniziale dei parametri euclidiani MODE 1
            new EuclideanLine(17, 5, 0, ''),
            new EuclideanLine(8, 1, 4, ''),
            new EuclideanLine(24, 9, 0, ''),
            new EuclideanLine(8, 3, 2, '')
        ],
    ...
    latinAmerica: [
        ...
        [ // Lista iniziale dei parametri euclidiani MODE 1
            new EuclideanLine(10, 4, 0, ''),
            new EuclideanLine(8, 1, 4, ''),
            new EuclideanLine(16, 5, 0, ''),
            new EuclideanLine(8, 3, 2, '')
        ],
