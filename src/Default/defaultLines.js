...
let defaultLines = {
    ...
    middleEast: [  
        [
        new EuclideaLine(5, 2, 0, 'Greek Rhythm 1'),
        new EuclideaLine(7, 2, 0, 'Macedonian Lesnoto Dance'),
        new EuclideaLine(7, 3, 0, 'Greek Rhythm 2'),
        new EuclideaLine(7, 3, 5, 'Serbian Rhythm 1'),
        new EuclideaLine(7, 3, 3, 'Turkish Rhythm 1'),
        new EuclideaLine(5, 4, 0, 'Greek Mirena Rhythm'),
        new EuclideaLine(5, 4, 2, 'Greek Tik Rhythm'),
        new EuclideaLine(7, 4, 0, 'Bulgarian Ruchenitza Folk Dance'),
        new EuclideaLine(7, 4, 3, 'Greek Kalamatianos Dance'),
        new EuclideaLine(9, 4, 0, 'Turkish Aksak'),
        new EuclideaLine(9, 4, 7, 'Bulgarian and Serbian Rhythm'),
        new EuclideaLine(9, 4, 5, 'Bulgarian and Greek Rhythm'),
        new EuclideaLine(9, 4, 3, 'Turkish Rhythm 2'),
        new EuclideaLine(11, 4, 5, 'Serbian Rhythm 2'),
        new EuclideaLine(8, 5, 5, 'Turkish Musemmen'),
        new EuclideaLine(9, 5, 5, 'Turkish Nawahiid'),
        new EuclideaLine(11, 5, 7, 'Macedonian Kalajdzijsko Oro Dance'),
        new EuclideaLine(13, 5, 0, 'Macedonian Rhythm 1'),
        new EuclideaLine(13, 5, 5, 'Macedonian Rhythm 2'),
        new EuclideaLine(7, 6, 2, 'Greek Pontakos'),
        new EuclideaLine(13, 6, 0, 'Macedonian Mama Cone Pita Dance'),
        new EuclideaLine(13, 6, 9, 'Macedonian Postupano Oro Dance'),
        new EuclideaLine(9, 7, 0, 'Greek Bazaragana'),
        new EuclideaLine(10, 7, 0, 'Turkish Lenk Fahhte'),
        new EuclideaLine(15, 7, 11, 'Bulgarian Rhythm 1'),
        new EuclideaLine(16, 7, 13, 'Yugoslavian Rhythm 1'),
        new EuclideaLine(17, 7, 14, 'Macedonian Rhythm 3'),
        new EuclideaLine(18, 7, 0, 'Bulgarian Rhythm 2'),
        new EuclideaLine(17, 8, 0, 'Bulgarian Rhythm 3'),
        new EuclideaLine(17, 8, 9, 'Bulgarian Rhythm 4'),
        new EuclideaLine(19, 8, 0, 'Bulgarian Rhythm 5'),
        new EuclideaLine(19, 8, 16, 'Bulgarian Rhythm 6'),
        new EuclideaLine(22, 9, 19, 'Bulgarian Rhythm 7'),
        new EuclideaLine(23, 9, 0, 'Bulgarian Rhythm 8'),
        new EuclideaLine(24, 11, 21, 'Bulgarian Rhythm 9'),
        new EuclideaLine(34, 15, 4, 'Bulgarian Rhythm 10')
        ],
       [  // Lista iniziale dei parametri euclidiani MODE 1
        new EuclideanLine(7, 3, 4, ''),
        new EuclideanLine(8, 1, 0, ''),
