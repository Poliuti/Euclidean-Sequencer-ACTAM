...
import indiaDefault from "./indiaDefault";
...
export const IndiaContext = createContext();

const IndiaContextProvider = (props) => { // this context provides common info within the africa environment
  ...
  const [linesList, setLinesList] = useState(indiaDefault); // memorizzo la lista di linee euclidiane in uno stato
...
export default IndiaContextProvider;