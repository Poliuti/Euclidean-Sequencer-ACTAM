...
import southAmericaDefault from "./southAmericaDefault";
...
export const SouthAmericaContext = createContext();

const SouthAmericaContextProvider = (props) => { // this context provides common info within the africa environment
  ...
  const [linesList, setLinesList] = useState(southAmericaDefault); // memorizzo la lista di linee euclidiane in uno stato
...
export default SouthAmericaContextProvider;